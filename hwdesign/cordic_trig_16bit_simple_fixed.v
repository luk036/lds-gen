/*
Simple 16-bit CORDIC Trigonometric Module - Fixed for Yosys
...
module cordic_trig_16bit_simple_fixed (
    input clk,
    input rst_n,
    input start,
    input [15:0] angle,
    ...
    // Temporary variables moved outside always block for Yosys compatibility
