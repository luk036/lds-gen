...
def generate_sphere3hopf_reference():
    ...
    for base_0, base_1, base_2 in base_triples:
        ...
        for i in range(1, 6):
            ...
            print(f"k={i:2d}: [{point[0]:10.6f}, {point[1]:10.6f}, {point[2]:10.6f}, {point[3]:10.6f}]")
    ...
    for i, sim_raw in enumerate(sim_values_raw):
        ...
        print(f"k={k}: Sim=[{sim_float[0]:10.6f}, {sim_float[1]:10.6f}, {sim_float[2]:10.6f}, {sim_float[3]:10.6f}]")
        print(f"    Exp=[{expected[0]:10.6f}, {expected[1]:10.6f}, {expected[2]:10.6f}, {expected[3]:10.6f}]")
    ...
    print(f"Sim=[{sim_reseed_float[0]:10.6f}, {sim_reseed_float[1]:10.6f}, {sim_reseed_float[2]:10.6f}, {sim_reseed_float[3]:10.6f}]")
    print(f"Exp=[{expected_reseed[0]:10.6f}, {expected_reseed[1]:10.6f}, {expected_reseed[2]:10.6f}, {expected_reseed[3]:10.6f}]")
    print(f"Err=[{error_x:.6f}, {error_y:.6f}, {error_z:.6f}, {error_w:.6f}]")
    ...
    for i, sim_raw in enumerate(sim_values_raw):
        ...
        radius_sq = sim_float[0]**2 + sim_float[1]**2 + sim_float[2]**2 + sim_float[3]**2
