...
def generate_disk_reference():
    ...
    for i, sim_raw in enumerate(sim_values_raw):
        ...
        print(
            f"k={k}: Sim=[{sim_float[0]:10.6f}, {sim_float[1]:10.6f}] "
    ...
    sim_reseed_raw = [0, 0]
    sim_reseed_float = [
        sim_reseed_raw[0] / 2147483648.0,
        sim_reseed_raw[1] / 2147483648.0,
    ]
    ...
    print(
        f"Sim=[{sim_reseed_float[0]:10.6f}, {sim_reseed_float[1]:10.6f}] "
